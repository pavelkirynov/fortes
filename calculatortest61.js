    ...
    const onDataLoaded = (data) => {
        ...
        function handleFurniture(furniture, FurnitureMarkup) {
            ...
            if (furnitureBool) {
                ...
                bedroomTotal = ((element.bed + element.matress) * (amountOfRooms - 1)) + element.cupboard + element.bedChair + element.mirror + element.shelves * amountOfRooms;
                ...
                decorationsTotal = element.jalousie + element.coffeeTable * (amountOfRooms - 1);
            }
        ...
        function handleMaterials(materials) {
            ...
            generalTotal = element.door * (amountOfBathrooms + amountOfRooms) + element.kafel * amountOfBathrooms * 35 + 0.66 * element.corniceWall * space + 0.66 * element.corniceCeiling * space + 0.59 * element.plinth * space + parseFloat(parseData("H77", space)) * element.electricalFurniture;
        ...
        function handleOptions(options) {
            ...
            let conditioning = optionsBool.conditioning * element.conditioningSplit * space + element.conditioner * (1 + 1 / parseData("S113")) * 1.05;
            ...
            $("#conditioning").siblings(".label").html(`Кондиціювання <span class=\"grey\">+${Math.round((element.conditioningSplit * space + element.conditioner * (1 + 1 / parseData("S113")) * 1.05) / (space * 28.5))}$/м²</span>`);
        ...
        function handleTotal() {
            ...
            let options = {
                ...
                neoclassic: {
                    ...
                    wallsDenoising: parseFloat(parseData("Q108", space)),
