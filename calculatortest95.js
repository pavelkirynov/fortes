    ...
    const onDataLoaded = (data) => {
        ...
        function handleOptions(options) {
            ...
            console.log(floorScreed + " " + shower + " " + heatedFlooring + " " + secondGypsumLayer + " " + denoising1 + " " + denoising2 + " " + conditioning + " " + entranceDoors);
        ...
        function handleTotal() {
            ...
            console.log(parseInt(handleFurniture(furniture, FurnitureMarkup)) + " " + parseFloat(handleMaterials(materials)) * (1 + (AccessorriesMarkup / 100)) + " " + handleWork(work, months) * (1 + (AccessorriesMarkup / 100)) + " " + parseInt(handleOptions(options)));
