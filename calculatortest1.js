...
const onDataLoaded = (data) => {
    ...
    function handleTotal() {
        console.log(handleAppliances());
        console.log(handleFurniture());
        console.log(handleConditioning());
        console.log(handleWork());
        console.log(handleOptions());
        console.log(handleMaterials());
        return (handleAppliances() + handleConditioning() + handleFurniture() + ((handleMaterials() + handleWork()) * (1 + (AccessorriesMarkup / 100))) + handleOptions()) / (28.5 * space);
    }
