    ...
    if (!!appliancesBoolTotal) {
        ...
        if (appliancesCookie == "gorenje") {
            ...
            for (let key in element) {
                ...
                $appliances.children(".option-block .list-option-container appliances").last().append(`<span class=\'name white\'>${parseData("F" + (161 + i))} ${parseData("E" + (161 + i))}</span><span class=\'list-text white\'>${parseFloat(parseData("D"+ (161+i)))} грн.</span>`);
