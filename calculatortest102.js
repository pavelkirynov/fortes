    ...
    const onDataLoaded = (data) => {
        ...
        function handleFurniture(furniture, FurnitureMarkup) {
            ...
            lightingTotal = (element.spotlight * (0.48 * space)) + element.chandelier * (amountOfRooms - 1) + element.kitchenWallLight + element.livingroomFloorLight + element.hangingLight + element.kitchenCeilingLight * 2 + element.bedsideLight * 2;
