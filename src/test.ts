...
fetch(
  ...
  .then((text: string) => {
    ...
    console.log(table.getCell(`A130`));
    console.log(table.getCell(`B130`));
    console.log(table.getCell(`C130`));
    console.log(table.getCell(`D130`));
    console.log(table.getCell(`E130`));
    //console.log(table.getCell(`A130`).value());
  });
