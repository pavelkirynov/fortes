...
function handleWork(work, months) {
    ...
    plinthTotal = (element.plinth + element.plinthHidden + element.water + element.canalisation + amountOfBathrooms * element.ventilation) * space + optionsBool.entranceDoors * element.doors;
...
function handleMaterials(materials) {
    ...
    materialsTotal = generalTotal + bathroomTotal + flooringTotal+ 7000*furnitureBool;
