...
const onDataLoaded = (data) => {
    ...
    /*let sum = 0;
    for (var key in materials.modern) {
    	sum += parseFloat(materials.modern[key]);
    }
    console.log(sum);*/
    ...
    function handleMaterials() {
        ...
        materialsTotal = (generalTotal + bathroomTotal + flooringTotal + furnitureBool * element.delivery) * (1 + (AccessorriesMarkup / 100));
